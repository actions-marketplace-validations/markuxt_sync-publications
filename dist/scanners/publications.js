 ...
 */
export async function scanExistingPublications(publicationsDir) {
    ...
    for (const file of files) {
        ...
        if (fm._hidden === 'true' || fm._hidden === true)
            continue;
        ...
        const authors = Array.isArray(fm.authors) ? fm.authors : undefined;
